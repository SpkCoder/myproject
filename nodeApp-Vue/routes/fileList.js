...
const upload = multer({ dest: '../uploadFile/',limits: { fileSize: 100*1024*1024, files:10 }});
...
// http://localhost:3000/nodejs/fileList?action=delData&dataJson={"age":{"$in":[10,33]}}  //删除文件
