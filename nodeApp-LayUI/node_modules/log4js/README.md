...
log4js.configure({
    appenders: { 
    	out: { type: 'file', filename: '../log/console.log', maxLogSize: 1024*100} 
    },
    categories: {
    	default: { appenders: ['out'], level: 'info' }
    }
});
var logger_log4js = log4js.getLogger('out');
logger_log4js.level = 'info';//trace, debug, info, warn, error, fatal

app.use(log4js.connectLogger(logger_log4js, {level:'INFO'}));
