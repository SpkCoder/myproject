	...
	<div class="view-body clearfix">
		...
		<div class="list-page-box clearfix">
                ...
                <div class="eChart_bottom_box clearfix">
                  <div id="eChart2" style="width:50%;height:250px;"></div>
                  <div id="eChart3" style="width:50%;height:250px;"></div>
                </div>
...
export default {
  ...
  data () {
      ...
      _this.$axiosHttp.get(_this.url, {"params":reqData}).then(function (res) {
        ...
        res.info.type_name.forEach(function (item, index) {
          if(item != "ALL"){
            ...
            option3.series.push({ name: item, type: 'line', lineStyle: {width: 1}, data: res.info[item] })
          }
        });
    ...
    searchCancelSubmit() {
      ...
      sessionStorage.removeItem("dns_req_list_whereJson");
      this.getData();
    }
  },
  watch: {
