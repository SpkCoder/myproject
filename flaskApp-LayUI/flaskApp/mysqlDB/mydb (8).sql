...
--
-- Host: localhost:3306
-- Generation Time: 2018-09-18 11:27:02
...
(1, '图片', '截图2.jpg', '34681', '/public/uploadFile/2018-02-11-16-04-21-77___截图2.jpg', 'yuxian', '2018-02-11 00:50:55');
...
(31, 'yuxian', 100004, 'user_list', '用户列表', '登录', 'action=SignIn', 'windows', '1920x1080', '127.0.0.1', '2018-09-17 10:02:14'),
(32, 'yuxian', 100004, 'user_list', '用户列表', '登录', 'action=SignIn', 'windows', '1920x1080', '127.0.0.1', '2018-09-17 18:30:42'),
(33, 'yuxian', 100004, 'user_list', '用户列表', '登录', 'action=SignIn', 'windows', '1920x1080', '127.0.0.1', '2018-09-18 14:08:46'),
(34, 'yuxian', 100004, 'user_list', '用户列表', '退出', 'action=SignOut', 'windows', '1920x1080', '127.0.0.1', '2018-09-18 15:56:20'),
(35, 'yuxian', 100004, 'user_list', '用户列表', '登录', 'action=SignIn', 'windows', '1920x1080', '127.0.0.1', '2018-09-18 15:56:23'),
(36, 'yuxian', 100004, 'user_list', '用户列表', '登录', 'action=SignIn', 'windows', '1920x1080', '127.0.0.1', '2018-09-18 17:21:07');
