! function(e, t) {
	...
	return function(e) {
		...
		var n = function() {
				...
				return i("div", {
					...
					attrs: {
						...
						size: e.selectSize,
						disabled: e.selectDisabled,
						readonly: !e.filterable || e.multiple || !e.visible,
						"validate-event": !1
					},
					on: {
						focus: e.handleFocus,
		...
		var n = i(16),
			...
			K = function(e, t, i) {
				return e === z && K(B, t, i), y(e), t = x(t, !0), y(i), s(L, t) ? (i.enumerable ? (s(e, F) && e[F][t] && (e[F][t] = !1), i = w(i, {
					enumerable: C(0, !1)
				})) : (s(e, F) || E(e, F, C(1, {})), e[F][t] = !0), W(e, t, i)) : E(e, t, i)
			},
			G = function(e, t) {
				y(e);
		...
		R || (P = function() {
			...
			return this._k
		}), S.f = Z, M.f = K, i(86).f = k.f = J, i(40).f = X, i(57).f = Q, r && !i(58) && o(z, "propertyIsEnumerable", X, !0), p.f = function(e) {
			return q(f(e))
		}), a(a.G + a.W + a.F * !R, {
			Symbol: P
		});
		...
		var s = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
			...
			f = function() {
				...
				return e.prototype.setData = function(e) {
					...
					if(!(t instanceof e)) {
						if(!n) {
							var s = this.getChildren() || []; - 1 === s.indexOf(t.data) && (void 0 === i || i < 0 ? s.push(t.data) : s.splice(i, 0, t.data))
						}(0, o.default)(t, {
							parent: this,
							store: this.store
						}), t = new e(t)
