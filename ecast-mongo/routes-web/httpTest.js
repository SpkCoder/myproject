...
// http://localhost:3000/nodejs/httpTest?action=findDataLookup&fromJson={"dbName":"roleClass","pk":"roleClass_id","fk":"id","as":"lookup"}&searchJson={"name":"mick"}&fieldJson={"name":1}&prePageNum=10&currPage=1&sortJson={"key":1}  //查询关联数据
