...
#/python/role_class req_data { "action":"findData", "limit":10, "page":1, "tocken": "eyJhbGciOiJIUzIbmFtZSmei4" }  //查询数据
#/python/role_class req_data { "action":"insertData", "dataArr":[{"class_name":"超级用户"}], "tocken": "eb2xlX2lkIj4gphmei4" }  //插入数据
#/python/role_class req_data { "action":"updateData", "whereJson":{"id":"1"}, "updateJson":{"class_name":"超级用户"}, "tocken": "eb2xlX2lkIj4gphmei4" }  //修改数据
#/python/role_class req_data { "action":"delData", whereJson={"id":[1,3]}, "tocken": "eyJhbGciOiJIUzIbmFtZSmei4" }  //删除数据


class model(object):
    def __init__(self,req):
        self.req = req 
        self.table_name = 'role_class'
