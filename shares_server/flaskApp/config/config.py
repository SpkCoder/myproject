...
env_name = 'production' 		#注意只能是这三个值中的任何一个[development,production,testing]

if env_name == 'development':
	from flaskApp.config.config_dev import * 
elif env_name == 'testing':
	from flaskApp.config.config_test import *
elif env_name == 'production':
	from flaskApp.config.config_pro import * 	 
else:
